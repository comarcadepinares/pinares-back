...
const getActivityLineMiddleware = require('./middlewares/getActivityLine')
const getActivityPointMiddleware = require('./middlewares/getActivityPoint')
...
module.exports = function (app) {
    ...
    activityRouter.post('/:slug/option/:id/line', auth.validate, getActivityMiddleware(true), getActivityOptionMiddleware(true), activityOptionController.addLine)
    activityRouter.delete('/:slug/option/:id/line/:lineId', auth.validate, getActivityMiddleware(true), getActivityOptionMiddleware(true), getActivityLineMiddleware(true), activityOptionController.removeLine)
    activityRouter.post('/:slug/option/:id/point', auth.validate, getActivityMiddleware(true), getActivityOptionMiddleware(true), activityOptionController.addPoint)
    activityRouter.delete('/:slug/option/:id/point/:pointId', auth.validate, getActivityMiddleware(true), getActivityOptionMiddleware(true), getActivityPointMiddleware(true), activityOptionController.removePoint)
